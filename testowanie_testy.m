...
%   UWAGA! w main nie moze byc clear all, bo usuwa licznik!!!!!!!!!!!!!!!!!
    ...
    if(size_warn(2) == 0 && size_warn(1) == 0)
       ...
       nazwa = strcat('testy\Sasiedztwo_2_dane_test_rzeczywiste\Sasiedztwo_2_dane_test_rzeczywiste_',...
...
save('testy\Sasiedztwo_2_dane_test_rzeczywiste\wyniki_testu.mat','wyniki',...
