...
global Bledy;
load('testy\Sasiedztwo_10_dane_test_rzeczywiste\wyniki_testu.mat');

licznik = Nr_best_workspace; %zeby bylo jawnie
nazwa = strcat('testy\Sasiedztwo_10_dane_test_rzeczywiste\Sasiedztwo_10_dane_test_rzeczywiste_',...
